...
var pages = ["about", "papers", "talks", "supervision"].map(function (name) {
...
$("#email").on("click", function (e) {
  e.preventDefault();
  var address = ["rob", ".", "cornish", "@", "stats", ".", "ox", ".", "ac", ".", "uk"].join("");
  $("#email").html(address).attr("href", "mailto:".concat(address));
});